...
cd ../../../..
cd frameworks/av
git apply -v ../../device/ark/benefit_m7/patches/framework_av/0001-mt6735.patch
cd ../..
cd frameworks/base
git apply -v ../../device/ark/benefit_m7/patches/framework_base/0001-mt6735.patch
cd ../..
cd packages/apps/Settings/
git apply -v ../../../device/ark/benefit_m7/patches/packages_apps_Settings/0001-Patch-for-6735-mtk.patch
cd ../../..
cd frameworks/opt/telephony
git apply -v ../../../device/ark/benefit_m7/patches/framework_opt_telephony/0001-mt6735.patch
cd ../../..
